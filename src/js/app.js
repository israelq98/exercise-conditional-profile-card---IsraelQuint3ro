...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "Add name"} ${
    ...
    variables.country ? variables.country : " | select country"
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/${
              variables.twitter ? variables.twitter : "Please add you twitter"
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github ? variables.github : "please add your Github"
            }"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${
              variables.linkedin
                ? variables.linkedin
                : "Please add you Linkedin"
            }"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${
              variables.instagram
                ? variables.instagram
                : "Please add your instagram"
